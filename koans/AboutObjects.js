describe("About Objects", function() {
    ...
    var meglomaniac = { 
      ...
      battleCry: function(noOfBrains) {
        return "They are " + this.henchman + " and the" +
          ...
          //NOTE returns noOfBrains value of "Brain" in string (instead of +1) bc it's an emptry array
      }
    };
  ...
  describe("'in' keyword", function() {
    ...
    it("should have the bomb", function() {
      var hasBomb = "theBomb" in meglomaniac;  //interesting. never seen this syntax. IT ONLY CHECKS PRESENCE, not value (see below)
  ...
  it("should use prototype to add to all objects", function() {
        ...
        //interesting object construction:
